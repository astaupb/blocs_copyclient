...
void main() {
  test('Fill Job with json data and get stringified map', () {
    ...
    expect(
        job.toString(),
        equals(
            '{id: 134818, timestamp: 1564768316, info: {filename: AStA Copyclient Benutzeranleitung.pdf, title: , pagecount: 4, colored: 4, a3: false, landscape: true}, options: {color: false, duplex: 0, copies: 1, collate: false, a3: false, range: , nup: 1, nuppageorder: 0, keep: false, bypass: true, displayname: test.pdf}, estimation: 20}'));
  });
